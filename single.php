			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					<div class="entry-header text-center">
						...
						<h4 class="entry-meta"><span>By</span> <a href="#">Arbites</a>   <span>in</span>  <a href="#">Beauty, Lifestyle</a> <span>at</span> <a href="#">August 4, 2017</a></h4>
					</div>
				</div>
				<div class="col-lg-12">	
					<div class="entry-media">
						<img src="<?php echo get_stylesheet_directory_uri()?>/images/single-post.jpg" alt="post-image">
					</div>
				</div>
				<div class="col-lg-8 offset-lg-2">
					...
					<div class="comments-list">
						...
						<div class="mar-top-xs">
							<div class="comment-block mt-0">
								<div class="userpic"><img src="<?php echo get_stylesheet_directory_uri()?>/images/user_1.png" alt="Larry"></div>
								<div class="content">
							...
							<div class="comment-block reply">
								<div class="userpic"><img src="<?php echo get_stylesheet_directory_uri()?>/images/user_2.png" alt="Barry"></div>
								<div class="content">
							...
							<div class="comment-block">
								<div class="userpic"><img src="<?php echo get_stylesheet_directory_uri()?>/images/user_1.png" alt="Frederick"></div>
								<div class="content">
							...
							<div class="comment-block reply">
								<div class="userpic"><img src="<?php echo get_stylesheet_directory_uri()?>/images/user_2.png" alt="Eliza"></div>
								<div class="content">
